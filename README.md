...
* 0.5.14.0007 Beta vom 31.08.2019 [Release Notizen](./CHANGELOG.md)
...
Das im dist/ Ordner erzeugte npm-Paket 'speech-react-0.5.14.tgz' kann in den eigenen React Projektordner kopiert werden.

Die Installation des 'speech-react-0.5.14.tgz' npm-Paketes erfolgt im eigenen React Projektordner mit folgendem Befehl:

    $ npm install speech-react-0.5.14.tgz
